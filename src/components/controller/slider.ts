...
export default function sliderTestimonials(): void {
  // const container = document.querySelector('.container-slider') as HTMLDivElement;
  ...
  range.addEventListener('change', sliderTestimonials);
}
